...
describe('injector', function() {
  ...
  it('has a constant that can be registerd to a module', function() {
    var module = angular.module('myModule', []);
  ...
  it('invokes an annotated function with dependency injectoin', function() {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  describe('annotate', function() {
    ...
    it('returns nan empty array for a non-annotated 0-arg function', function() {
      var injector = createInjector([]);
      var fn = function() { };
    ...
    it('strips severalcomments from arguments lists when parsing', function() {
      var injector = createInjector([]);
    ...
    it('strips out // when parsing', function() {
      var injector = createInjector([]);
  ...
  it('instatiates an annotated constructor function', function() {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
